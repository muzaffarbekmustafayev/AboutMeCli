              ...
              >
                ...
                <div className="p-8 flex flex-col flex-grow relative z-10">
                  ...
                  <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400 mb-8">
                    {projectFeatures.slice(0, 3).map((feature, i) => (
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-[#0f172a] rounded-3xl max-w-2xl w-full p-8 relative shadow-2xl">
            ...
            <h2 className="text-3xl font-bold mb-6 dark:text-white">
              {t(`portfolio.items.${activeProject.id}.title`, {
                defaultValue: activeProject.title,
              })}
            </h2>

            <p className="text-gray-600 dark:text-gray-400 mb-6">
              {t(`portfolio.items.${activeProject.id}.description`, {
